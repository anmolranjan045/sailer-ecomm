...
class Profile(BaseModel):
    ...
    def __str__(self):
        return self.user.first_name + str(' ') + str(self.user.last_name)
...
class Cart(BaseModel):
    ...
    def get_cart_total_no_coupon(self):
        cart_items = self.cart_items.all()
        price = []
        for cart_item in cart_items:
            price.append(cart_item.product.price)
...
class BuyerDeliveryAddress(BaseModel):
    ...
    verified_user = models.ForeignKey(Profile, on_delete=models.CASCADE, related_name='user_address')
